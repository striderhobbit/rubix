...
> = {
  b: {
    ...
    twist: new Twist({ axis: 'z', degree: { B: -1, S: -1 } }),
  },
  B: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'z', degree: { B: -1 } }),
  },
  d: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'y', degree: { E: 1, D: 1 } }),
  },
  D: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'y', degree: { D: 1 } }),
  },
  E: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'y', degree: { E: 1 } }),
  },
  f: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'z', degree: { S: 1, F: 1 } }),
  },
  F: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'z', degree: { F: 1 } }),
  },
  l: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'x', degree: { L: -1, M: -1 } }),
  },
  L: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'x', degree: { L: -1 } }),
  },
  M: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'x', degree: { M: -1 } }),
  },
  r: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'x', degree: { M: 1, R: 1 } }),
  },
  R: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'x', degree: { R: 1 } }),
  },
  S: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'z', degree: { S: 1 } }),
  },
  u: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'y', degree: { U: -1, E: -1 } }),
  },
  U: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'y', degree: { U: -1 } }),
  },
  x: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'x', degree: { L: 1, M: 1, R: 1 } }),
  },
  y: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'y', degree: { U: -1, E: -1, D: -1 } }),
  },
  z: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'z', degree: { B: 1, S: 1, F: 1 } }),
  },
};
