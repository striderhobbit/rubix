...
> = {
  b: {
    ...
    twist: new Twist({ axis: 'z', order: { B: -1, S: -1 } }),
  },
  B: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'z', order: { B: -1 } }),
  },
  d: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'y', order: { E: 1, D: 1 } }),
  },
  D: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'y', order: { D: 1 } }),
  },
  E: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'y', order: { E: 1 } }),
  },
  f: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'z', order: { S: 1, F: 1 } }),
  },
  F: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'z', order: { F: 1 } }),
  },
  l: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'x', order: { L: -1, M: -1 } }),
  },
  L: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'x', order: { L: -1 } }),
  },
  M: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'x', order: { M: -1 } }),
  },
  r: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'x', order: { M: 1, R: 1 } }),
  },
  R: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'x', order: { R: 1 } }),
  },
  S: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'z', order: { S: 1 } }),
  },
  u: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'y', order: { U: -1, E: -1 } }),
  },
  U: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'y', order: { U: -1 } }),
  },
  x: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'x', order: { L: 1, M: 1, R: 1 } }),
  },
  y: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'y', order: { U: -1, E: -1, D: -1 } }),
  },
  z: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ axis: 'z', order: { B: 1, S: 1, F: 1 } }),
  },
};
