...
export const baseMoves: Record<
  BaseMove,
  { permutation: Permutation; twist: Twist }
> = {
  b: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ degree: { B: -1, S: -1 }, slice: 'z' }),
  },
  B: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ degree: { B: -1 }, slice: 'z' }),
  },
  d: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ degree: { E: 1, D: 1 }, slice: 'y' }),
  },
  D: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ degree: { D: 1 }, slice: 'y' }),
  },
  E: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ degree: { E: 1 }, slice: 'y' }),
  },
  f: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ degree: { S: 1, F: 1 }, slice: 'z' }),
  },
  F: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ degree: { F: 1 }, slice: 'z' }),
  },
  l: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ degree: { L: -1, M: -1 }, slice: 'x' }),
  },
  L: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ degree: { L: -1 }, slice: 'x' }),
  },
  M: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ degree: { M: -1 }, slice: 'x' }),
  },
  r: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ degree: { M: 1, R: 1 }, slice: 'x' }),
  },
  R: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ degree: { R: 1 }, slice: 'x' }),
  },
  S: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ degree: { S: 1 }, slice: 'z' }),
  },
  u: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ degree: { U: -1, E: -1 }, slice: 'y' }),
  },
  U: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ degree: { U: -1 }, slice: 'y' }),
  },
  x: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ degree: { L: 1, M: 1, R: 1 }, slice: 'x' }),
  },
  y: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ degree: { U: -1, E: -1, D: -1 }, slice: 'y' }),
  },
  z: {
    permutation: new Permutation(27 * 6).setFromCycles(
    ...
    twist: new Twist({ degree: { B: 1, S: 1, F: 1 }, slice: 'z' }),
  },
};
